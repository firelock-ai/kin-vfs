...
//! Wire protocol types mirroring the daemon's protocol.rs.
//!
//! These MUST stay in sync with `kin-vfs-daemon/src/protocol.rs` so that
//! rmp-serde serialization is wire-compatible.
